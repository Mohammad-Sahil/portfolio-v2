...
const defaultDescription = "I'm Mohammad Sahil — a passionate full stack developer skilled in React, Next.js, Node.js, Firebase, Flutter & more. I've led production-ready projects and built scalable dashboards, admin panels, and mobile apps.";
